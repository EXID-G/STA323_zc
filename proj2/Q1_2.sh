...
validation_file = "${workdir}data/mydata/myvalid_20.csv"
...
python Q1_2.py --model_path $model_path --train_file $train_file --validation_file $validation_file --test_file $test_file --output_dir $output_dir --best_model_dir $best_model_dir --local_dir $local_dir --traindata_process_save_path $traindata_process_save_path --validationdata_process_save_path $validationdata_process_save_path --testdata_process_save_path $testdata_process_save_path